...
public class CreateCommentCommand implements ActionCommand {
	...
	private final static String COMMENT_ERROR = "modal.comment";
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) 
		...
		comment.setProductId(Long.parseLong(request.getParameter(ParameterName.PRODUCT_ID)));
		...
		try {
			...
			request.setAttribute(ParameterName.MODAL_MESSAGE, 
					messageManager.getProperty(COMMENT_ERROR, response.getLocale()));
