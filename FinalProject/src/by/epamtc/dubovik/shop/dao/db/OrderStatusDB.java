...
public class OrderStatusDB implements OrderStatusDAO {
	...
	private OrderStatus takeFromResultSet(ResultSet resultSet) throws SQLException {
		...
		if (!resultSet.isAfterLast()) {
			...
			status.setId(resultSet.getInt(OrderStatusMapping.ID));
	...
	@Override
	public OrderStatus findById(int id) throws DAOException {
